...
return [
    ...
    'title' => 'API BloodBank - Documentation',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'API complète pour la gestion des dons de sang, banques de sang, urgences et géolocalisation.',
    ...
    'routes' => [
        [
            'match' => [
                ...
                // Match only routes whose versions match this pattern (use * as a wildcard to match any characters). Example: 'v1'.
                'versions' => ['v1'],
            ],
            ...
            'exclude' => [
                // Exclure les routes de test
            ],

            // Apply these transformations to the routes
            'apply' => [
                'headers' => [
    ...
    'auth' => [
        ...
        'extra_info' => 'Vous pouvez obtenir votre clé d\'authentification en vous connectant via l\'endpoint /api/auth/login',
    ],
...
INTRO
    ...
    'examples' => [
        ...
        'models_source' => ['factoryCreate', 'factoryMake', 'modelFirst', 'modelFind'],
    ],
