    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div>
                ...
                >
                    <svg class="loading-spinner w-5 h-5 mr-2 hidden" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
...
class BloodBanksMap {
    ...
    createBankPopup(bank) {
        ...
        const totalStock = bank.blood_stocks ? bank.blood_stocks.reduce((sum, stock) => sum + (stock.quantity_ml || 0), 0) : 0;
        const hasLowStock = bank.blood_stocks ? bank.blood_stocks.some(stock => (stock.quantity_ml || 0) <= 1000) : false;
    ...
    resetLocationButton() {
        ...
        if (locationBtn) {
            ...
            locationIcon.innerHTML = '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/>';
    ...
    updateResults() {
        ...
        mapInfo.textContent = `${count} banque${count > 1 ? 's' : ''} affichée${count > 1 ? 's' : ''} sur la carte`;
    ...
    setLocationLoading(loading) {
        ...
        if (loading) {
            ...
            locationIcon.innerHTML = '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" class="animate-spin"/>';
        }
    }
