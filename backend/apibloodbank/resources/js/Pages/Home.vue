                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div class="text-center lg:text-left">
                        ...
                        <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                            <router-link to="/blood-banks" class="border-2 border-white text-white hover:bg-white hover:text-red-600 font-semibold rounded-lg transition-colors inline-flex items-center text-lg px-8 py-4">
                            ...
                            <router-link to="/register" class="bg-white text-red-600 hover:bg-red-50 font-semibold rounded-lg transition-colors inline-flex items-center text-lg px-8 py-4">
                                <svg class="w-5 h-5 mr-2 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <section class="py-20 bg-gray-50">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <router-link to="/register" class="bg-red-600 hover:bg-red-700 text-white px-8 py-4 rounded-lg font-semibold text-lg transition-colors">
                        Commencer maintenant
                    </router-link>
                    <router-link to="/about" class="border border-gray-300 text-gray-700 hover:bg-gray-50 px-8 py-4 rounded-lg font-semibold text-lg transition-colors">
                        En savoir plus
                    </router-link>
                </div>
            </div>
